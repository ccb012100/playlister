...
namespace Playlister.Services
{
    public interface ISpotifyApiService
    {
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<PagingObject<PlaylistItem>> GetPlaylistTracks(string accessToken, string playlistId, int? offset,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<PagingObject<PlaylistItem>> GetPlaylistTracks(string accessToken, Uri next, CancellationToken ct);
        ...
        /// <returns></returns>
        Task<PagingObject<SimplifiedPlaylistObject>> GetCurrentUserPlaylists(string accessToken, CancellationToken ct,
        ...
        Task<PagingObject<SimplifiedPlaylistObject>> GetCurrentUserPlaylists(string accessToken, Uri next,
        ...
        /// <param name="ct"></param>
        /// <returns></returns>
        Task<SimplifiedPlaylistObject> GetPlaylist(string accessToken, string playlistId, CancellationToken ct);
    }
}
