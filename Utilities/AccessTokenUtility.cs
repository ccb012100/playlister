...
namespace Playlister.Utilities
{
    public class AccessTokenUtility : IAccessTokenUtility
    {
        ...
        public AccessTokenUtility(IHttpContextAccessor contextAccessor, ILogger<AccessTokenUtility> logger)
        {
        ...
        {
            if (_contextAccessor is null) throw new InvalidOperationException("IHttpContextAccessor is null.");
            if (_contextAccessor.HttpContext is null) throw new InvalidOperationException("httpContext");

            if (!AuthenticationHeaderValue.TryParse(_contextAccessor.HttpContext.Request.Headers["Authorization"],
