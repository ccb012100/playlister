...
[Migration( 001, "Add the tables to the database" )]
public class Fm001AddPlaylistTable : AutoReversingMigration
{
    ...
    private void CreateTables()
    {
        ...
        Create.Table( DataTables.Album )
            ...
            .AsString()
            .NotNullable()
            .WithColumn( "total_tracks" )
            .AsInt16()
            .NotNullable()
            .WithColumn( "album_type" )
            .AsString()
            .Nullable()
        ...
        Create.Table( DataTables.Track )
            ...
            .AsString()
            .NotNullable()
            .WithColumn( "track_number" )
            .AsInt16()
            .NotNullable()
            .WithColumn( "disc_number" )
            .AsInt16()
            .NotNullable()
