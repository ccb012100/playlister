...
namespace Playlister.RefitClients
{
    public interface ISpotifyApi
    {
        ...
        [Get("/me")]
        Task<PrivateUserObject> GetCurrentUser([Authorize] string token, CancellationToken ct);
        ...
        Task<SimplifiedPlaylistObject> GetPlaylist([Authorize] string token, string playlistId, CancellationToken ct);
        ...
        Task<PagingObject<SimplifiedPlaylistObject>> GetCurrentUserPlaylists([Authorize] string token, int? offset,
            int? limit,
        ...
        Task<PagingObject<PlaylistItem>> GetPlaylistTracks([Authorize] string token, string playlistId, int? offset,
            int? limit,
            CancellationToken ct);
    }
}
